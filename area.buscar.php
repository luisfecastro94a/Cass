...
<a href="area.php"><button  class="btn btn-default" type="submit"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"> NUEVO</span></button></a>
<a href="area.buscar.php"><button class="btn btn-default" type="submit"><span class="glyphicon glyphicon-search" aria-hidden="true"> BUSCAR</span></button></a>
...
<h4><label for="caja_busqueda"><h1>Lista de las Areas</h1></label></h4>
...
<thead>
      <th colspan="1"><a href="area.php" class="btn btn-primary">Nueva Area</a></th>
     
    </thead>
    <tbody>
      <tr>
       
        <td><h4>Nombre de Area</h4></td>
...
<?php
  ...
  $dbhandle=mysql_query("SELECT * FROM area ");


   while($muestra=mysql_fetch_array($dbhandle)){
   echo '<tr>';
   echo '<td>'.'<strong>'.$muestra['area'].'</strong>'.'</td>';
