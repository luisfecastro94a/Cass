...
$nuevo_usuario=mysql_query("SELECT area FROM area WHERE area='$area'"); 
...
"; 
  ...
  $consulta=mysql_query("INSERT INTO area (area) VALUES ('$area')") or die(mysql_errno());
   echo '<script> alert("Area Creada con Exito."); </script>';
}
