...
<h4><label for="caja_busqueda"><h1>Lista de Ciudad</h1></label></h4>
...
<thead>
      <th colspan="1"><a href="ciudad.php" class="btn btn-primary">Nueva Ciudad</a></th>
     
    </thead>
    <tbody>
      <tr>
       
        <td><h4>Nombre Ciudad</h4></td>
...
<?php
  ...
  $dbhandle=mysql_query("SELECT * FROM ciudad ");


   while($muestra=mysql_fetch_array($dbhandle)){
   echo '<tr>';
   echo '<td>'.'<strong>'.$muestra['nombrec'].'</strong>'.'</td>';
