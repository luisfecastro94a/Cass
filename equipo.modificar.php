...
<select id="nombreCliente" class="form-control" name="id_cliente"  value="" autofocus=""> 
...
include("conexion.php");
      ...
      $Encargado = isset($_POST['id_cliente_encargado'])? $_POST['id_cliente_encargado']:''; 
...
$selected = mysql_select_db("bdcass",$dbhandle) 
  ...
  mysql_query("UPDATE equipo SET id_cliente='$Cliente', id_cliente_encargado='$Encargado', sintoma_tecnico='$sintoma_tecnico', id_estado='$id_estado'WHERE id_equipo='$id'")or die(mysql_error());
