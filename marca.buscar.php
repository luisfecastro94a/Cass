...
<h4><label for="caja_busqueda"><h1>Lista de Marcas</h1></label></h4>
...
<thead>
      <th colspan="1"><a href="ciudad.php" class="btn btn-primary">Nueva Marca</a></th>
     
    </thead>
    <tbody>
      <tr>
       
        <td><h4>Nombre Marca</h4></td>
...
<?php
  ...
  $dbhandle=mysql_query("SELECT * FROM Marca ");
