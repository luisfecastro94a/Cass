...
$query=mysql_query("UPDATE  cliente SET id_ciudad=$Ciudad, nombre='$Nombre', rut='$Rut' , fono='$Fono' , correo='$Correo' , giro='$Giro' , direccion='$Direccion' , nombre_contacto='$Nombre_contacto' , fono_contacto='$Fono_contacto' , correo_contacto='$Correo_contacto' , cargo_contacto='$Cargo_contacto' , condicion_pago='$Condicion_pago' WHERE id_cliente='$id'");
