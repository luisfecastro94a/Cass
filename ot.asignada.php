...
$query= "SELECT orden_trabajo.correlativo_ot, orden_trabajo.fecha_OT, orden_trabajo.valorCotizacionOT, equipo.serie_equipo,  estado.estado, estado.Condicion , usuario.nivel, usuario.nombreUsuario FROM orden_trabajo INNER JOIN usuario ON orden_trabajo.id_usuario=usuario.id_usuario INNER JOIN estado ON orden_trabajo.id_estado=estado.id_estado INNER JOIN equipo ON orden_trabajo.id_equipo=equipo.id_equipo  WHERE nivel='Laboratorio' AND Condicion='Eo'  ";
