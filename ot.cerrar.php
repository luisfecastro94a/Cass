...
<div class="col-xs-5">
<label class="fe" for="">Fecha Cierre<input class="" value="<?php echo date('d/m/Y')?>" type="text" name="fecha_cierre" id="fecha_cierre"></label>
</div><!--fecha con jquey-->
...
<label class="coti" for="">Estado</label>
  ...
  <input type="radio" name="inlineRadioOptions" id="inlineRadio2" value="4" required=""> Cerrada
</label>
  </div>
</div>
